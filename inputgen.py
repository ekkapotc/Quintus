...
for i in range(0, records):
    ...
    v1s.append(random.uniform(8000,22000))
    v2s.append(random.uniform(8000,22000))
    v3s.append(random.uniform(8000,22000))
    v4s.append(random.uniform(8000,22000))
    v5s.append(random.uniform(8000,22000))
    v6s.append(random.uniform(8000,22000))
    v7s.append(random.uniform(8000,22000))
    v8s.append(random.uniform(8000,22000))
